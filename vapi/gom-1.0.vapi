/* gom-1.0.vapi generated by lt-vapigen, do not modify. */
...
namespace Gom {
	...
	public abstract class Resource : GLib.Object {
		[CCode (has_construct_function = false)]
		protected Resource ();
		public void build_save_cmd (Gom.Adapter adapter);
		public async bool delete_async () throws GLib.Error;
		public bool delete_sync () throws GLib.Error;
		public bool do_delete (Gom.Adapter adapter) throws GLib.Error;
		public bool do_save (Gom.Adapter adapter) throws GLib.Error;
		...
		public void set_post_save_properties ();
