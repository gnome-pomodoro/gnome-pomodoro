...
namespace Pomodoro
{
    public class VirtualCapabilityTest : Pomodoro.TestSuite
    {
        public VirtualCapabilityTest ()
        {
...
//                           this.test_fallback_dispose);
        ...
        {
            var capability = new Pomodoro.VirtualCapability ("anti-gravity", true);
        ...
        public void test_new_with_fallback ()
        {
            ...
            var capability2 = new Pomodoro.VirtualCapability.with_fallback (fallback);
            assert (capability2.name == fallback.name);
        }

        /**
         * Unit test for Pomodoro.Capability.set_fallback() method.
         *
         * Virtual capability lacks implementation, it's handled by fallback.
         * Enabled state of the fallback should be the same as of capability.
         */
        public void test_set_fallback ()
        {
            /* Case 1 */
            var capability1 = new Pomodoro.VirtualCapability ("anti-gravity", false);
            ...
            /* Case 2 */
            var capability2 = new Pomodoro.VirtualCapability ("anti-gravity", false);
            ...
            /* Case 3 */
            var capability3 = new Pomodoro.VirtualCapability ("anti-gravity", true);
            ...
            /* Case 4 */
            var capability4 = new Pomodoro.VirtualCapability ("anti-gravity", true);
...
//
//            capability1.set_fallback_full (fallback1, false);
//            capability1.dispose ();
//
//            assert (fallback1.enabled);
//        }
        ...
        {
            /* Case 1 */
            var capability1 = new Pomodoro.VirtualCapability ("anti-gravity", true);
            var fallback1   = new Pomodoro.Capability ("anti-gravity", false);
